...
export const SERVICES: Service[] = [
  {
    ...
    description: 'Dedicated leadership for global e-commerce and logistics. I handle the complexity so you can focus on scale.',
    ctaText: 'Check Availability'
  },
  {
    id: 'consulting',
    title: 'Operations Consulting',
    description: 'Process optimization using Six Sigma Greenbelt methodology. I audit, analyze, and streamline your workflows.',
    ctaText: 'Book a Consult'
  },
  {
    id: 'dashboards',
    title: 'Dashboard Creation',
    description: 'Custom Power BI and Advanced Excel (PivotTables, Index-Match) solutions to visualize your growth and KPIs.',
    ctaText: 'Request a Dashboard'
  }
];
